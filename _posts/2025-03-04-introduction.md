---
title: Introduction
description: Introducing me and my website.
date: 2025-03-04 16:05:00 -06:00
...
You will first need a GitHub account. This is because I use [giscus](https://github.com/giscus/giscus) to power the comment and reaction feature. Giscus uses GitHub Discussions, which is what the website GitHub uses so that people can comment on projects.

For my non-technical audience, think of GitHub as a place developers showcase their coding projects and collaborate with other developers to contribute to open-source code to make it better. You don't need to be a programmer to make a GitHub account, just think of it like signing up for FaceBook or Instagram so that you can comment on my posts if you want. You can create an account [here on their signup page](https://github.com/signup).
...
I hope you enjoy my blog and are even inspired to do something similar. My ideal world is that everyone has their own websites or otherwise decentralized spaces to have full control over their data and content, fully owning their digital presence. This is perhaps unrealistic, and not everyone cares about creating a website or anything like that, which is fine. But I do suggest checking out [Privacy Guides](https://www.privacyguides.org) to find out how to be more private online. They are a not-for-profit, volunteer-run project that covers a wide range of tools such as VPNs, password managers, email providers, browser extensions, and more. You can also build a website just like mine with minimal web development experience by using [Jekyll](https://jekyllrb.com/) templates.

Expect many posts about traveling, professional projects I may be working on, and especially [tea reviews](https://steepster.com/preah).