...
tags: [small]     # TAG names should always be lowercase
---
Here is this week's shareables.

### Shares

**- Buy books secondhand online for way cheaper than new at [Better World Books](https://www.betterworldbooks.com/)**
...
I have been getting more into cooking lately, especially after binging [Tasting History with Max Miller](https://www.youtube.com/@TastingHistory). I have been moving toward a Mediterranean diet more both for health and personal taste, and that has been going great so far (actually getting enough fiber in a day, wow!), so I want to try a lot of new recipes. Not all of them will be strictly Mediterranean, but they will at least be plant-based and use fresh ingredients as much as possible.
...
**- [Free download of Microsoft Office 2007 from Archive.org](https://archive.org/details/microsoft-office-2007-sp3)**

For if you want to avoid paying for modern MS Office but don't want to switch to [LibreOffice](https://www.libreoffice.org/) for some reason. Or, you think 2007 Office is fun.
...
**- [If nothing is curated, how do we find things?](https://tadaima.bearblog.dev/if-nothing-is-curated-how-do-we-find-things/) article by Tadaima**

Just a small blog post I found interesting about the emphasis on curation. It is indeed annoying having to search through reddit to get real human opinions on things, or find really interesting stuff on my own that none of my friends know about because some random blog or [Hacker News](https://news.ycombinator.com/) thread talked about it. I meet people who seeimgly only get news by scrolling Reddit, Instagram, Tumblr, Facebook (really?), etc. and it's concerning. I wish more people would [make RSS feeds](https://preahs.com/posts/why-rss-feeds-are-still-relevant-and-how-to-use-them/) of [things they actually like](https://wiki.melonland.net/rss_guide), including certain social media accounts, and ditch algorithmic slop recommendation altogether.

**- On a similar note, [here's a cool website called minifeed I found to browse small blogs](https://minifeed.net/) and even follow them directly from the site!**
...
![Desktop View](/assets/img/lossytimelines.png){: width="972" height="589" }
_Why should I care about Bluesky's Lossy Timelines?_

**- Check out retro website-building on [MelonLand](https://melonking.net/frames/forum)**

[MelonLand](https://wiki.melonland.net) is a site dedicated to what's called [web revival](https://wiki.melonland.net/web_revival), or
